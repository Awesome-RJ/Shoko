...
import Shoko.modules.sql.notes_sql as sql
from Shoko import dispatcher, MESSAGE_DUMP, LOGGER
from Shoko.modules.disable import DisableAbleCommandHandler
from Shoko.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Shoko.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Shoko.modules.helper_funcs.msg_types import get_note_type
from Shoko.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from Shoko.modules.helper_funcs.alternate import typing_action
from Shoko.modules.connection import connected
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask in @Shokobot if you're unable to figure it out!"
            )
